...
/* ** argv: Values of arguments */
{
  ...
  if (row == 1){ // LAPACK_ROW_MAJOR
    ...
    // cblas_dgbmv(CblasRowMajor,CblasNoTrans,la,la,kl,ku,2.0, AB,lab,EX_SOL,1,0.0, RHS,1);
    ...
    cblas_dgbmv(CblasColMajor,CblasNoTrans,la,la,kl,ku,2.0, AB,lab,EX_SOL,1,0.0, RHS,1);
  }    
